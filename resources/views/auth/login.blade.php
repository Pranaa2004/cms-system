...
<html dir="ltr">
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16"
            href="{{ Vite::asset('resources/backend/assets/images/logo/logo11.png') }}">
        <title>Login</title>
        <!-- Custom CSS -->
...
<![endif]-->
    ...
    <body>
            ...
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
                ...
                <div class="auth-box row">
                    <div class="col-lg-7 col-md-5 modal-bg-img"
                        style="background-image: url({{ Vite::asset('resources/backend/assets/images/big/3.jpg') }});">
                    </div>
                    <div class="col-lg-5 col-md-7 bg-white">
                        <div class="p-3">
                            ...
                            <form class="mt-4" action="/post-login" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12 text-center mt-5">
                                        Don't have an account? <a href="{{ route('register_show') }}"
        ...
        <!-- All Required js -->
        <!-- ============================================================== -->
        @vite(['resources/backend/assets/libs/jquery/dist/jquery.min.js', 'resources/backend/assets/libs/popper.js/dist/umd/popper.min.js', 'resources/backend/assets/libs/bootstrap/dist/js/bootstrap.min.js'])
